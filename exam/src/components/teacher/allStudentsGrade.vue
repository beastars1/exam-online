...
<template>
  <div class="all">
    <el-table :data="pagination.records" border>
      <el-table-column fixed="left" prop="id" label="学号" width="100"></el-table-column>
      ...
      <el-table-column prop="clazz" label="班级" width="130"></el-table-column>
<!--      <el-table-column prop="email" label="联系方式" width="150"></el-table-column>-->
      <el-table-column fixed="right" label="查看成绩" width="120">
...
export default {
  ...
  methods: {
    getAnswerInfo() {
      //分页查询所有试卷信息
      this.$axios.get(`/api/student/page?page=${this.pagination.current}&size=${this.pagination.size}`)
        .then(res => {
